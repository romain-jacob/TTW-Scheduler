%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% scheduleVisualizationResource.m
% Function to visualize the schedules according to resource
% Input:
% - APs - processors
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function scheduleVisualizationResourceFull(APs, APPs, Tasks, Msgs, CCs, CommonTaskSchedules, CommonMsgSchedules, ModeSchedules, ModeAppSets, numLCM)
%%
